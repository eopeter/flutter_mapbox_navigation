...
public class FlutterMapboxNavigationPlugin : FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler, ActivityAware {
    ...
    companion object {
        ...
        var allowsUTurnsAtWayPoints = false
    ...
    private fun checkPermissionAndBeginNavigation(@NonNull call: MethodCall, @NonNull result: MethodChannel.Result) {
        ...
        val _alternatives = arguments?.get("simulateRoute") as? Boolean
        if (_alternatives != null) {
            alternatives = _alternatives
        }

        val _allowsUTurnsAtWayPoints = arguments?.get("simulateRoute") as? Boolean
        if (_allowsUTurnsAtWayPoints != null) {
            allowsUTurnsAtWayPoints = _allowsUTurnsAtWayPoints
        }
